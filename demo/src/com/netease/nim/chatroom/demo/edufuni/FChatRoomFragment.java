 ...
 */
public class FChatRoomFragment extends TFragment implements ViewPager.OnPageChangeListener, AVChatStateObserver, View.OnClickListener {
     ...
     * 直播区域（上）
     */
    private LinearLayout videoLayout; // 直播/播放区域
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fchat_room_fragment, container, false);
    }
    ...
    public void onAttach(Context context) {
        ...
        this.activity = (FChatRoomActivity) context;
     ...
     * 加入FChatRoomFragment
     */
    public void addFChatRoomFragment(){
       getFragmentManager().beginTransaction().replace(R.id.fchat_room_message_layout,new FChatRoomMessageFragment()).commit();
    ...
    public void onOnlineStatusChanged(boolean isOnline) {
        ...
        NIMClient.getService(ChatRoomService.class).fetchRoomInfo(roomId).setCallback(new RequestCallback<ChatRoomInfo>() {
            ...
            public void onSuccess(ChatRoomInfo chatRoomInfo) {
                ...
                ((FChatRoomActivity) getActivity()).setRoomInfo(roomInfo);
                updateDeskShareUI();
            }
    ...
    private void requestLivePermission() {
        MPermission.with(FChatRoomFragment.this)
    ...
    public void onPermissionChange(List<String> accounts) {
        ...
        for (String a : oldAccounts) {
            ...
            if (accounts.contains(a)) {
                ...
                // 如果是自己，取消互动
                if (TextUtils.equals(a, DemoCache.getAccount())) {
