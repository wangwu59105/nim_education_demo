...
import static com.netease.nim.chatroom.demo.education.adapter.OnlinePeopleAdapter.OnlinePeopleItem;
...
public class OnlinePeopleViewHolder extends TViewHolder {
    ...
    protected void refresh(Object item) {
        ...
        if (onlinePeopleItem.getChatRoomMember().getAccount().equals(DemoCache.getAccount())) {
            // item为自己，判断是否有互动权限
            ...
            // item为别人的情况
            if (onlinePeopleItem.getCreator().equals(DemoCache.getAccount())) {
                // 自己是主播
                if (isHandsUp) {
                    // 举手的时候
                    agreeToInteraction();
